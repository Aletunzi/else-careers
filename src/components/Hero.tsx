  ...
  return (
    <>
      <section className="flex flex-1 flex-col items-center justify-center px-5 py-10 text-center sm:justify-start sm:px-8 sm:pt-20 sm:pb-16 md:pt-28">
        <h1 className="animate-fade-in text-[clamp(1.85rem,7.9vw,2.75rem)] font-normal leading-tight text-foreground sm:whitespace-nowrap sm:text-4xl md:text-5xl lg:text-[3.25rem] xl:text-[3.5rem] 2xl:text-7xl" style={{ animationDelay: '150ms', animationFillMode: 'both' }}>
