const Hero = () => {
  return (
    <section className="flex flex-1 flex-col items-center justify-center px-5 py-16 text-center sm:px-8 md:py-20">
      ...
      <p className="animate-fade-in mt-4 text-sm text-muted-foreground sm:mt-5 sm:text-base md:text-lg 2xl:text-xl lg:whitespace-nowrap" style={{ animationDelay: '150ms', animationFillMode: 'both' }}>
        Else is here to help you find your next product job at the top tech companies worldwide.
      </p>
      <div className="animate-fade-in mt-8 flex w-full max-w-4xl flex-col gap-3 rounded-2xl bg-card px-8 py-7 shadow-sm sm:mt-12 sm:flex-row sm:items-center sm:px-10 sm:py-8 2xl:max-w-5xl 2xl:px-12 2xl:py-9" style={{ animationDelay: '300ms', animationFillMode: 'both' }}>
        <input
          type="text"
