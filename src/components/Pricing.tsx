  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <h2
          className={`mt-6 max-w-none text-4xl font-medium leading-[1.05] text-foreground transition-all duration-700 ease-out sm:text-5xl md:text-6xl lg:whitespace-nowrap lg:text-[64px] xl:text-[68px] ${inView ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-3"}`}
          style={{ transitionDelay: inView ? "120ms" : "0ms" }}
        >
          A plan for every <span className="whitespace-nowrap">kind of search.</span>
        </h2>
