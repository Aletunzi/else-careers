  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div
          ref={listRef}
          className="relative mx-auto mt-14 flex max-w-3xl flex-col gap-4 pb-8 sm:mt-16"
          style={
            listHeight
              ...
              <VacancyRow
                ...
                detailHeight={
                  isSelected && listHeight && firstCardHeight
                    ? listHeight - firstCardHeight + (gap || 0)
                    : undefined
                }
              />
            );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          minHeight: selected && detailHeight ? `${detailHeight}px` : undefined,
...
const InlineDetail = ({
  ...
  return (
    <div className="flex h-full flex-col justify-center border-t border-foreground/5 px-5 pb-5 pt-5 sm:px-8 sm:pb-6 sm:pt-6">
        {/* Score gauge */}
        ...
        {/* Strengths & gaps */}
        <div className="grid grid-cols-1 gap-4 pt-8 sm:grid-cols-2 sm:gap-6 sm:pt-10">
          <div
          ...
          >
            ...
            <ul className="mt-3 space-y-2 sm:mt-2 sm:space-y-1.5">
